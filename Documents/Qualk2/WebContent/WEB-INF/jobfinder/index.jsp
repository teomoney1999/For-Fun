      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12" data-aos="fade">
            <h1>Find Job</h1>
            <form action="${ pageContext.request.contextPath }/home" method="post"> <!-- red -->
              <div class="row mb-3">
                <div class="col-md-9">
                  <div class="row">
                    <div class="col-md-6 mb-3 mb-md-0">
                      <input type="text" class="mr-3 form-control border-0 px-4" placeholder="job title, keywords or company name " name="keyword">
                    </div>
                    <div class="col-md-6 mb-3 mb-md-0">
                      <div class="input-wrap">
                        <span class="icon icon-room"></span>
                      <input type="text" class="form-control form-control-block search-input  border-0 px-4" id="autocomplete" name="location" placeholder="city, province or region" onFocus="geolocate()">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <p class="small">or browse by category: <a href="javascript:void(0)" class="category">Category #1</a>, <a href="javascript:void(0)" class="category">Category #2</a></p>
                </div>
              </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-4 col-lg-3 mb-3" data-aos="fade-up" data-aos-delay="100">
            <a href="javascript:void(0)" class="h-100 feature-item">
        ...
        <div class="row">
          <div class="col-md-8 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="rounded border jobs-wrap">
              ...
              <a href="${ pageContext.request.contextPath }/job-single" class="job-item d-block d-md-flex align-items-center freelance">
                ...
                <div class="job-category align-self-center">
                  <div class="p-3">
                    <span class="text-warning p-2 rounded border border-warning">Gold Digger</span>
                  </div>
                </div>  
              </a>
          ...
          <div class="col-md-4 block-16" data-aos="fade-up" data-aos-delay="200">
            <div class="d-flex mb-0">
              ...
              <div class="ml-auto mt-1"><a href="javascript:void(0)" class="owl-custom-prev">Prev</a> / <a href="javascript:void(0)" class="owl-custom-next">Next</a></div>
            </div>
      ...
      <div class="container">
        ...
        <div class="d-block d-md-flex border-bottom">
          <div class="text-center p-4 item border-right" data-aos="fade">
            ...
            <p><a href="javascript:void(0)">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
      ...
      <div class="container">
        ...
        <div class="nonloop-block-15 owl-carousel">
            ...
            <div class="media-with-text">
              ...
              <h2 class="heading mb-0 h5"><a href="javascript:void(0)">Jobs are made easy</a></h2>
              <span class="mb-3 d-block post-date">January 20, 2018 &bullet; By <a href="javascript:void(0)">Josh Holmes</a></span>
