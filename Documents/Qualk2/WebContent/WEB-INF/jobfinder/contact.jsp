        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4"><a href="javascript:void(0)">+1 232 3235 324</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="javascript:void(0)">youremail@domain.com</a></p>
            ...
            <div class="p-4 mb-3 bg-white">
              ...
              <p><a href="javascript:void(0)" class="btn btn-primary px-4 py-2 text-white pill">Learn More</a></p>
            </div>
          </div>
        </div>
      </div>
